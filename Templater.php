...
class Templater
{
    ...
    protected $path = '/View/view.%s.%s';
    protected $allowedHeadTags = ['title', 'meta', 'link', 'script'];

    protected $template;
    protected $pageTitle = 'Standalone App | %s';
    ...
    protected function getPageTitle()
    {
        ...
        {
            $this->pageTitle = \sprintf($this->pageTitle, 'Index');
        }
    ...
    public function render(string $template, array $params = [])
    {
        ...
        {
            $params = array_merge(
                (array) \Templater\Set::setObject($this->_globals),
                $params
            );
        }
